...
@router.get("/", response_model=list[ApplicationResponse], summary="Get all applications", description="Retrieve all applications with optional pagination")
...
@router.get("/{username}", response_model=list[ApplicationResponse], summary="Get applications by username")
...
@router.post("/", response_model=ApplicationResponse, status_code=201, summary="Create a new application")
